...
class AttBlock(nn.Module):
    def __init__(self, device, f_size, in_size, out_size, dropout_p):
        ...
        self.lin_alpha = Linear(f_size, in_size, bias=False, weight_initializer='glorot')
    ...
    def forward(self, f, x, h, edge_index, edge_type, f_batch, x_batch):
        ...
        pa = self.pa_identifier(x, pc_edge_index)
        bro = self.bro_identifier(x, bb_edge_index)
