...
from src.model.DecoderBatchEval import DecoderBatchEval
...
class Model(nn.Module):
    def __init__(
        ...
        self.decoder = DecoderBatchEval(device, enc_out_size, dec_h_size, emb_size, vocab_size, end_node_token_id, tokenizer)
    ...
    def forward(self, data):
        ...
        y, y_batch, y_edge_index, y_edge_type, y_score, y_edge_rel_score, embeds, gcn1_alpha, gcn2_alpha, gcn3_alpha = \
