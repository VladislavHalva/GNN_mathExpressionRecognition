...
class Encoder(nn.Module):
    def __init__(self, edge_features, edge_h_size, in_size, h_size, out_size, vocab_size, vgg_dropout_p, gat_dropout_p):
        ...
        self.vgg = VGG(1, vocab_size, dropout_p=vgg_dropout_p)
        # self.vgg = torchvision.models.vgg13(pretrained=True)
        # self.vgg.classifier[6] = nn.Linear(4096, in_size)

        self.gat1 = GATConv(vocab_size, h_size, edge_features, edge_h_size, dropout=gat_dropout_p)
        self.gat2 = GATConv(h_size, h_size, edge_h_size, edge_h_size, dropout=gat_dropout_p)
        self.gat3 = GATConv(h_size, out_size, edge_h_size, edge_h_size, dropout=gat_dropout_p)
